...
exports.config = {
  ...
  ###
  modules: ["server","minify-js","minify-css","jshint","csslint","live-reload","require","bower","copy","vault","client-jade-static","coffeescript","ember-handlebars","emblem","jade","stylus","testem-simple"]
